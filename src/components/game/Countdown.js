      ...
      <div className="countdown">
        <div className="countdown__colored-blocks">
          <div className="countdown__colored-blocks-rotater">
            <div className="countdown__colored-block"></div>
            <div className="countdown__colored-block"></div>
            <div className="countdown__colored-block"></div>
          </div>
          <div className="countdown__colored-blocks-inner"></div>
        ...
        <div className="countdown__inner">
          <svg className="countdown__numbers" viewBox="0 0 100 100">
            <defs>
              ...
              <path
                className="countdown__num-join-1-2"
                d="M55,78 55,83 a17,17 0 1,0 34,0 a20,10 0 0,0 -20,-10"
              />
              <path
                className="countdown__num-path-2"
                d="M69,73 l-35,0 l30,-30 a16,16 0 0,0 -22.6,-22.6 l-7,7"
              />
              <path
                className="countdown__num-join-2-3"
                d="M28,69 Q25,44 34.4,27.4"
              />
              <path
                className="countdown__num-path-3"
